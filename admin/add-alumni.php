...
$status=1;
$query=mysqli_query($con,"insert into members(name,email,department,batch,designation,commitee_year,current_position,status,image) values('$membername','$memberemail','$memberdept',
'$memberbatch','$memberdesignation','$commitee_year','$current_position','$status','$imgnewfile')");
if($query)
{
$msg="Alumni successfully added ";
}
else{
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Add Alumni </h4>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Add Alumni</button>
