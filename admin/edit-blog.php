...
$sql = "UPDATE blog SET title ='$blogtitle' , details = '$blogdetails', tags = '$tags', image = '$imgnewfile' WHERE blog.id = '$postid' ";
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"SELECT * FROM blog WHERE blog.id = '$postid'");
...
<input type="text" class="form-control" id="blogtitle" name="blogtitle" value="<?php echo htmlentities($row['title']);?>" required>
</div>
...
<textarea name="blogdescription" required><?php echo htmlentities($row['details']);?></textarea>
</div>
</div>
</div>
...
<input type="text" class="form-control" id="blogtags" name="blogtags" value="<?php echo htmlentities($row['tags']);?>" required>
</div>
