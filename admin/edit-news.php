...
$sql = "UPDATE news SET title ='$newstitle' , details = '$newsdetails', tags = '$tags', image = '$imgnewfile' WHERE news.id = '$postid' ";
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"SELECT * FROM news WHERE news.id = '$postid'");
...
<input type="text" class="form-control" id="newstitle" name="newstitle" value="<?php echo htmlentities($row['title']);?>" required>
</div>
...
<textarea name="newsdescription" required><?php echo htmlentities($row['details']);?></textarea>
</div>
</div>
</div>
...
<input type="text" class="form-control" id="newstags" name="newstags" value="<?php echo htmlentities($row['tags']);?>" required>
</div>
