...
$query=mysqli_query($con,"UPDATE aboutus SET aboutus = '$aboutus' WHERE id = 1");
if($query)
{
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>About us</b></h4>
<textarea rows="4" cols="50" name="aboutus" required> <?=$text?></textarea>
</div>
</div>
</div>
