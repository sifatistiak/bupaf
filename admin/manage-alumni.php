...
if($query)
{
$msg="Alumni Information deleted ";
}
else{
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>BUPAF | Manage Alumni</title>
...
<td><a href="manage-alumni.php?aid=<?php echo htmlentities($row['id']);?>&&task=member" onclick="return confirm('Do you want to make this Alumni a Member?')"><button type="button" class="btn btn-info"> <i class="fa fa-check" aria-hidden="true" style="color: yellow"></i></button></a> </td>


<td><a href="edit-alumni.php?pid=<?php echo htmlentities($row['id']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a>
    &nbsp;<a href="manage-alumni.php?pid=<?php echo htmlentities($row['id']);?>&&action=del" onclick="return confirm('Do you really want to delete ?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
 </tr>
<?php } }?>
