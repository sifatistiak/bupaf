<div class="container-fluid mtb-margin-top">
  <div class="row">
    <div class="col-md-12">
      ...
      $adjacents = 2;
      $sql = "SELECT COUNT(*) 'total_rows' FROM `blog`";
...
//
      ...
      if(mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_object($result)) {
          ...
          // echo '<img class="col-md-12 w-100 rounded img-fluid" style=" margin: 25% auto 25%; padding-right:0px; padding-left:0px;" src="../assets/img/blog/'.$row->image.'" alt="Not Found" onerror=this.src="../assets/img/blog/noimg.png">';
          // echo '</div>';
          // echo '<div class="col-md-10" style="">';
          echo '<h6 style="color:#D1B055; "><a style= "color:gold;" href="./blog_details.php?blog_id='.$row->id.'">'.$row->title.'</a></h6>';
          echo '<p style="text-align: justify;">'.substr($row->details,0,340).'&nbsp;&nbsp;<a href="./blog_details.php?blog_id='.$row->id.'">Read More...</a></p>';
          // echo '<br>';
