...
?>
  ...
  <div class="col-md-12" style="margin-top:8%;">
    ...
    <h3 style="width: 30%; color:#D1B055; font-family: 'Montserrat Bold';">NEWS DETAILS</h3>
  ...
  if(mysqli_num_rows($result) > 0) {
    while($row = mysqli_fetch_object($result)) {
      ...
      echo '<img class="col-md-4 w-70 rounded img-fluid text-center"  src="../assets/img/news/'.$row->image.'" alt="Not Found" onerror=this.src="../assets/img/news/noimg.png">';
      echo '</div>';
