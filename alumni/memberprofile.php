            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                ...
                <div class="form-row" style="margin-top:1rem;">
                  <button style="height: fit-content;" type="submit" name="submit" class="btn btn-success waves-effect waves-light">Update</button>
                  <button style="height: fit-content; margin-left:1rem;" type="reset" class="btn btn-danger waves-effect waves-light">Reset</button>
                </div>
                <br><br><br>
            </form>
          </div> <!-- end col -->
