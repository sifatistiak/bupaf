...
<body style="width:100%; height: 100%; margin: 0px; padding: 0px; overflow-x: hidden;">
  <div style="margin-left:12.5%;margin-right:12.5%;">
    ...
    <div class="col-md-12" style="margin-top:0%;">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <a href="nao/" style="text-decoration: none;">
  ...
  overflow-x: hidden;">
    ...
    background-color: transparent;">
        <button style="background-color: transparent;border: 1px solid #c8bf09d9;color: gold; outline:none;" id="slideLeft" type="button">
          <
            </button>
      ...
      <div class="row" id="contact_us" style="margin-top:2%">
        <div class="col-md-4">
          <p style="color:white; text-align: left; font-family: 'Montserrat'; font-size: 0.8em;">
            ...
            <br><br>
            Like us on facebook: <a href="//fb.com/bupafofficial" target="_top" style="color:white">fb.com/bupafofficial</a>
            <br>Follow us on Instagram: <a href="//ig.com/bupafofficial" target="_top" style="color:white">ig.com/bupafofficial</a>
            <br>
          </p>
  ...
  <!-- Go to www.addthis.com/dashboard to customize your tools -->
  <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-6038a0cb711cf48d"></script>
</body>
